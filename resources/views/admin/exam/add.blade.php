...
<div>
    ...
    <div class="row" style="margin-top: 50px"> 
        ...
        <div class="col-sm-10">
            <form  id="exam-form-data" action="{{route('admin.exam.add-exam',$id)}}" method="post">
                @csrf
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <input type="text" class="form-control" name="exam_name" value="">
                            </td>
                        </tr>
                        <tr>
                            <td class="weight">Thời gian làm bài<span class="text-danger">(*)</span></td>
                            <td> <input type="text" class="form-control" name="duration" value="">
                            </td>
                        </tr>
                        <tr>
                            <td class="weight">Mô tả bài thi<span class="text-danger">(*)</span></td>
                            <td> <textarea class="form-control" rows="5" name="description"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
